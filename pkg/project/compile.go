...
func renderDBTProject(projectName string) string {
	...
	// The PROFILE name is fixed: one profiles.yml entry ("loom_project")
	// serves every project. Per-project profile names sent the first live
	// agent off to edit the credentials file to make its run connect —
	// resourceful, and exactly what a stable name makes unnecessary.
