...
func TestLoadMigrations(t *testing.T) {
	...
	// Verify we have all 22 migrations.
	...
	// 000021_human_request_kind_summary, then 000022_human_request_params.
	assert.Len(t, migrations, 22, "should have 22 migration versions")
